...
const ctx = new SceneContext(loadableScene)

export const engine = Engine({
  onChangeFunction(entity: Entity, component: ComponentDefinition<any>, componentId: number, op: WireMessage.Enum) {
...
export const GltfContainer = components.GltfContainer(engine)
